use crate::ARCFM::{FuelRod, MainStruct};
...
pub fn send_command(command: &str, mainstruct: &mut MainStruct, height: u16) {
    ...
    match matches[..] {
        ...
        [7] => {
            ...
            for i in start..end {
                if i as usize >= help_strings.len() {
                    ...
                    mainstruct.data.log.insert(0, help_strings[i as usize].to_string());
                }
            }
        ...
        [10] => {
            ...
            mainstruct.menu.speed_setpoint = match speed.as_str() {
                "slow" => 0.1,
                "s" => 0.1,
                "medium" => 0.5,
                "m" => 0.5,
